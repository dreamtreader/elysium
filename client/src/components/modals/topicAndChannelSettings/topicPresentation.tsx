...
const Presentation = ({ topic }: { topic?: Topic }) => {
  ...
  return (
    <div className="max-w-[740px] min-h-[460px] grow shrink h-full px-[60px] pt-20">
      ...
      <form className="grid grid-cols-[1fr,_8rem] gap-10">
      ...
      <SaveChanges
        onSave={() => {
          ...
          socket.once("topicChanged", (topic) => {
            setInitialFormState({ name: topic.name, avatar: topic.avatar })
          })
        }}
